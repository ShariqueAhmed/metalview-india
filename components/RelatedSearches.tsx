...
const relatedSearches: Record<string, Array<{ 
  ...
  gold: [
    ...
    { label: 'Gold Price Today', href: '/gold', type: 'trend' },
    { label: 'Gold Price Guide', href: '/gold-price-guide', type: 'guide' },
    { label: 'Gold Investment Guide', href: '/investment-guide', type: 'guide' },
    { label: 'How to Calculate Gold Price', href: '/blog/how-to-calculate-gold-price', type: 'guide' },
  ...
  silver: [
    { label: 'Silver Price Today', href: '/silver', type: 'trend' },
    { label: 'Silver Investment Guide', href: '/silver-investment-guide', type: 'guide' },
    { label: 'Silver Price Trends 2026', href: '/blog/silver-price-trends-india-2026', type: 'trend' },
    { label: 'Gold vs Silver Investment', href: '/gold-vs-silver-investment', type: 'comparison' },
    { label: 'Investment Guide', href: '/investment-guide', type: 'guide' },
  ],
  copper: [
    { label: 'Copper Price Today', href: '/copper', type: 'trend' },
    { label: 'Copper Price Guide', href: '/copper-price-guide', type: 'guide' },
    { label: 'Copper & Industrial Demand', href: '/blog/copper-price-india-guide-industrial-demand', type: 'guide' },
    { label: 'Investment Guide', href: '/investment-guide', type: 'guide' },
  ],
  platinum: [
    { label: 'Platinum Price Today', href: '/platinum', type: 'trend' },
    { label: 'Platinum Price Guide', href: '/platinum-price-guide', type: 'guide' },
    { label: 'Platinum & Palladium Prices', href: '/blog/platinum-palladium-prices-india-guide', type: 'guide' },
    { label: 'Gold vs Silver Investment', href: '/gold-vs-silver-investment', type: 'comparison' },
  ],
  palladium: [
    { label: 'Palladium Price Today', href: '/palladium', type: 'trend' },
    { label: 'Palladium Price Guide', href: '/palladium-price-guide', type: 'guide' },
    { label: 'Platinum & Palladium Prices', href: '/blog/platinum-palladium-prices-india-guide', type: 'guide' },
    { label: 'Investment Guide', href: '/investment-guide', type: 'guide' },
  ],
};
