          ...
          >
            <div className="relative flex-shrink-0" aria-hidden="true">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-400/20 via-yellow-400/10 to-amber-600/20 dark:from-amber-300/30 dark:via-yellow-300/20 dark:to-amber-400/30 rounded-xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-amber-500 via-yellow-400 to-amber-600 dark:from-amber-400 dark:via-yellow-300 dark:to-amber-500 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-amber-500/30 dark:group-hover:shadow-amber-400/30 group-hover:scale-105 border border-amber-300/50 dark:border-amber-500/50">
                  <TrendingUp className="w-6 h-6 sm:w-7 sm:h-7 text-white dark:text-slate-900" strokeWidth={2.5} />
                </div>
                {/* Trust badge */}
                <div className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-emerald-500 dark:bg-emerald-400 rounded-full flex items-center justify-center border-2 border-white dark:border-slate-950 shadow-lg">
                  <CheckCircle2 className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white" strokeWidth={3} />
                </div>
              </div>
            </div>
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                {/* Premium badge */}
                <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-950/40 dark:to-yellow-950/40 border border-amber-200 dark:border-amber-800/50 rounded-full">
                  <Shield className="w-3 h-3 text-amber-600 dark:text-amber-400" strokeWidth={2.5} />
                  <span className="text-[10px] font-semibold text-amber-700 dark:text-amber-300">Trusted</span>
                </span>
              </div>
