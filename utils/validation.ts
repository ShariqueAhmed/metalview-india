...
export const MetalsApiResponseSchema = z.object({
  ...
  goldTrend18k: z.array(GoldTrendPointSchema).optional(),
  goldTrend22k: z.array(GoldTrendPointSchema).optional(),
  goldTrend24k: z.array(GoldTrendPointSchema).optional(),
