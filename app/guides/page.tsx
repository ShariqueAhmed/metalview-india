...
const GUIDE_LINKS = [
  ...
  },
  {
    ...
    description: 'Understand copper price benchmarks in India, industrial-demand drivers, and how to compare live copper rates with real supplier quotes.',
    icon: BookOpen,
    category: 'Copper',
  ...
  },
  {
    ...
    description: 'Learn how platinum prices are quoted in India, how platinum differs from gold, and how to evaluate platinum buying decisions.',
    icon: Award,
    category: 'Platinum',
  ...
  },
  {
    ...
    description: 'Practical guide to palladium prices in India, focused on niche benchmark interpretation and industrial-market context.',
    icon: BarChart3,
    category: 'Palladium',
