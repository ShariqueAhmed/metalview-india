...
import { blogIndexPosts, type BlogIndexPost } from '@/utils/blogIndexPosts';

const SITE_URL = getSiteUrl();
const blogPosts = blogIndexPosts;
...
function BlogCard({ post, variant }: { post: BlogIndexPost; variant: 'default' | 'city' }) {
